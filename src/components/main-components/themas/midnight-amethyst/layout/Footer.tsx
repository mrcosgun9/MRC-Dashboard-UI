...
const HomeFooter = () => {
  return (
    <footer className="relative z-10 pb-20 lg:pb-24 xl:pb-28 mt-14">
      ...
      <div className="relative mx-auto max-w-[1170px] px-4 pt-17.5 sm:px-8 xl:px-0">
        ...
        <div className="flex flex-wrap justify-between">
          <div className="mb-10 w-full max-w-[520px]">
            <a className="mb-8.5 inline-block" href="/">
              LOGO
            </a>
            <p className="mb-12 xl:w-4/5">Build SaaS AI applications using OpenAI and Next.js, this kit comes with pre-configured and pre-built examples, making it easier to quickly kickstart your AI startup.</p>
            <div className="flex items-center gap-5">
              ...
              <a href="#" aria-label="github" className="duration-300 ease-in hover:text-white">
                <svg className="fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex flex-col gap-10 sm:flex-row sm:justify-between">
              <div>
                ...
                <ul className="flex flex-col gap-3.5">
                  <li>
                    <a href="#" target="_self" rel="" className="font-medium duration-300 ease-in hover:text-white">Features</a>
                  </li>
                  <li>
                    <a href="#" target="_self" rel="" className="font-medium duration-300 ease-in hover:text-white">Integrations</a>
                  </li>
                  <li>
                    <a href="#" target="_self" rel="" className="font-medium duration-300 ease-in hover:text-white">Pricing</a>
                  </li>
                  <li>
                    <a href="#" target="_self" rel="" className="font-medium duration-300 ease-in hover:text-white">Changes log</a>
                  </li>
                  <li>
                    <a href="#" target="_self" rel="" className="font-medium duration-300 ease-in hover:text-white">Roadmap</a>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="flex flex-col gap-3.5">
                  <li>
                    <a href="#" target="_self" rel="" className="font-medium duration-300 ease-in hover:text-white">Privacy Policy</a>
                  </li>
                  <li>
                    <a href="#" target="_self" rel="" className="font-medium duration-300 ease-in hover:text-white">Refund Policy</a>
                  </li>
                  <li>
                    <a href="#" target="_self" rel="" className="font-medium duration-300 ease-in hover:text-white">Support</a>
                  </li>
                  <li>
                    <a href="#" target="_self" rel="" className="font-medium duration-300 ease-in hover:text-white">Community</a>
                  </li>
                </ul>
              </div>
              <div>
